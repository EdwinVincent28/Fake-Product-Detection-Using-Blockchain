...
export default function transferProduct() {
    ...
    try {
      ...
      .initialOwner( productCode, web3.utils.asciiToHex(sellerEmailAddress),web3.utils.asciiToHex(customerEmailAddress))
      .send({
        from: accounts[0]
      ...
      .getCodes(web3.utils.asciiToHex(customerEmailAddress))
      .call();
      console.log(result);
    } catch (err) {
      setDisplayAlert('');
  ...
  return <div>
      ...
      <div align =  'center'>
        <Text fontSize="2xl" fontWeight="bold">Transfer Product ( Seller to Customer)</Text>
      </div>
        <form onSubmit={onSubmit}>
            ...
            <FormControl  >
              <FormLabel htmlFor='email'> Customer Email address</FormLabel>
              <Input 
              id='email' 
              type='email' 
